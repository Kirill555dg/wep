...
Available components in `src/shared/ui/`:
...
All are named exports. Do not use `default` import for any shadcn component.
...
```tsx
import { Infinity, Plus, Trash2, Pencil, Check, X } from 'lucide-react'
```
